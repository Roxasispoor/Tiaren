...
public class Damage : EffectOnNetIdeable
{
    ...
    public Damage(NetIdeable target, NetIdeable launcher, int damageValue) : base(target, launcher)
    {
        this.DamageValue = damageValue;
    }
    public Damage(NetIdeable target, NetIdeable launcher, int damageValue, int numberOfTurns) : base(target, launcher, numberOfTurns)
    {
        this.DamageValue = damageValue;
    }
